...
public class SubmitButton extends View {
    ...
    private RectF mDynamicBounds,mArcBounds;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mCircleDashColor =array.getColor(R.styleable.SubmitButton_circleDashColor,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mArcBounds.left = mDynamicBounds.left - mBounds.height()/2;
        mArcBounds.right = mDynamicBounds.left + mBounds.height()/2;
        mArcBounds.bottom = mBounds.bottom;
        canvas.drawArc(mArcBounds,90,180,false,mPaint);
        mArcBounds.left = mDynamicBounds.right - mBounds.height()/2;
        mArcBounds.right = mDynamicBounds.right + mBounds.height()/2;
        canvas.drawArc(mArcBounds,-90,180,false,mPaint);
        if(sPathTrans){
